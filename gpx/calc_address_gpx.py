...
def calc(table, buffer):
    ...
    for row in record_result_set:
        ...
        result_one_tuple=()
        addr_num = calc_address_num(id, geom_txt, buffer)
        ...
        if row_index % uf.batch_number == 0:
            ...
            print("calc " + variable + " index for id = ", int(id), " row_index = " , row_index, " result= " , result_one_tuple, "; running time = ", time_diff_min, " mins! ", time_diff, " sec! ", " buffer = ", buffer)
            logger.info("calc " + variable +" index for id = "+ str(int(id))+  " row_index = " + str(row_index) + " result= " +  str(result_one_tuple) + "; running time = " +  str(time_diff_min) + " mins! " + str(time_diff) + " sec! buffer = " + str(buffer))
